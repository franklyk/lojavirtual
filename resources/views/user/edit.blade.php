...
<x-layout>
    <x-forms.fieldset legend="Edit" class="field-register">
        ...
        <x-forms.form enctype="multipart/form-data" action="/user/{{$user->id}}" method="post" class="form-edit" id="form-edit">
            @method('patch')
            ...
            <div class="row-column">
                <x-forms.input type="text" name="name" label="Nome" value="{{$user->name}}"/>
            </div>
            <div class="row-column">
