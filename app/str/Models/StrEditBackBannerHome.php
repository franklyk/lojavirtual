...
class StrEditBackBannerHome
{
    ...
    public function viewBanner(int|string|null $id = null): bool
    {
        $this->id = (int) $id;
    ...
    private function valInput(): void
    {
        ...
        if(($this->viewBanner($this->data['id'])) and ($valExtImg->getResult())){
            $this->upload();
    ...
    private function edit(): void
    {
        ...
        $upBanner->exeUpdate("str_banners_home", $this->data, "WHERE id=:id", "id=" . $this->data['id']);
    ...
    private function deleteImage(): void
    {
        if(((!empty($this->resultBd[0]['banner_background'])) or ($this->resultBd[0]['banner_background'] != null)) and ($this->resultBd[0]['banner_background'] != $this->nameImg)){
            $this->delImg = "app/str/assets/images/banners/" .$this->resultBd[0]['banner_background'];
    ...
    private function upload(): void
    {
        ...
        $this->directory = "app/str/assets/images/banners/";

        $uploadImgRes = new \App\str\Models\helper\StrUploadImgRes();
        $uploadImgRes->upload($this->dataImage, $this->directory, $this->nameImg, 1920, 900);
